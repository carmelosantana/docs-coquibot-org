...
- See [TOOLKITS.md](https://github.com/carmelosantana/coqui/blob/main/docs/TOOLKITS.md#mcp-toolkits) for the full core/optional split and [CONFIGURATION.md](/guides/configuration) for `mcp.json` and stdio command policy details.
