...
See the [Makefile](https://github.com/carmelosantana/coqui/blob/main/Makefile) for all available targets.
...
See [scripts/ci-test.sh](https://github.com/carmelosantana/coqui/blob/main/scripts/ci-test.sh) for details.
