...
- 📦 [**Runtime Extensibility**](https://github.com/AgentCoqui/coqui/blob/main/docs/FEATURES.md#runtime-extensibility) — install Composer toolkits at runtime; browse [coqui.space](https://agentcoqui.com)
