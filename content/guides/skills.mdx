...
```markdown
See [the API reference](https://github.com/carmelosantana/coqui/blob/main/docs/references/api-spec.md) for endpoint details.
```
...
- [PHP checklist](https://github.com/carmelosantana/coqui/blob/main/docs/references/php-checklist.md)
- [Security checklist](https://github.com/carmelosantana/coqui/blob/main/docs/references/security-checklist.md)
```
