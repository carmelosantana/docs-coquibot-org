...
Copy this file into `personas/your-profile/preferences.json` when you want a deliberate operator profile.

Source: [examples/preferences/deliberate-operator.json](https://github.com/carmelosantana/coqui/blob/main/examples/preferences/deliberate-operator.json)
