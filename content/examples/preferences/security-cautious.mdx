...
Use this as `personas/your-profile/security.md` when you want tighter approval boundaries.

Source: [examples/preferences/security-cautious.md](https://github.com/carmelosantana/coqui/blob/main/examples/preferences/security-cautious.md)
