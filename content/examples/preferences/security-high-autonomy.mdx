...
Use this as `personas/your-profile/security.md` when you want faster execution with explicit risk boundaries.

Source: [examples/preferences/security-high-autonomy.md](https://github.com/carmelosantana/coqui/blob/main/examples/preferences/security-high-autonomy.md)
