...
- 🤖 [**Multi-Model Orchestration**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#multi-model-orchestration) — route tasks to the right model with automatic failover
- 🔀 [**Agent Delegation**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#child-agent-delegation) — spawn specialized agents (coder, researcher, planner, reviewer, muse, philosopher) with role-appropriate models
- 🧠 [**Memory Persistence**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#memory-persistence) — cross-session memory with SQLite, FTS5, and optional vector embeddings
- 📦 [**Runtime Extensibility**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#runtime-extensibility) — install Composer toolkits at runtime; browse [coqui.space](https://agentcoqui.com)
- 🔐 [**Credential Management**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#credential-management) — declarative `.env`-based secrets with hot-reload and automatic guards
- 📋 [**Skills System**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#skills-system) — teach Coqui any workflow with plain Markdown files — no code required
- ⏰ [**Scheduled Tasks**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#scheduled-tasks) — cron-style automation with circuit breakers
- 🏗️ [**Background Tasks**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#background-tasks) — isolated processes for long-running work
- 🔁 [**Loops**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#loops) — fully automated multi-iteration workflows chaining roles in sequence
- 🧩 [**Cognitive Flexibility**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#cognitive-flexibility) — creative muse and philosopher roles, diverge-converge loops, sketch/hypothesis artifacts
- 🗂️ [**Artifacts & Plans**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#artifacts-and-plans) — versioned plan artifacts with draft→review→final lifecycle
- 🔧 [**Toolkit Visibility**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#toolkit-visibility) — 3-tier model (enabled/stub/disabled) to reduce token usage
- 🛡️ [**Layered Safety**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#layered-safety) — 5-layer security: sandbox → sanitizer → blacklist → approval → audit
- 🌐 [**HTTP API**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#http-api) — async REST + SSE server for dashboards and headless automation
- 💾 [**Persistent Sessions**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#persistent-sessions) — SQLite-backed conversations that survive restarts
- 👁️ [**Vision Analysis**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#vision-analysis) — analyze images from URLs, files, or base64 data
- 🪶 [**Soul**](https://github.com/carmelosantana/coqui/blob/main/docs/FEATURES.md#soul) — customizable orchestrator identity via `prompts/soul.md`
...
| [Projects](/features/projects) | Lean project working scopes |
...
See [AGENTS.md](https://github.com/carmelosantana/coqui/blob/main/AGENTS.md) for code conventions and architecture guidelines.
